...
- (int)match:(NSArray *)otherCards
{
    ...
    //***maybe use a for loop to interate through array to check cards
    //***how to check with for loop.  Check first one with all of them then check the second one with only what's left
    //@should work for n matches
    if ([otherCards count]) {
